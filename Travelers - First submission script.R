...
class(train_val3$veh_ratio)

#View(test2)

tdboost_fit <- TDboost(claimcst0 ~. , data=train_val3, distribution = list(name="EDM",alpha=1.7),cv.folds=2, n.trees=300, interaction.depth = 20)
...
write.csv(submission,"First_submission.csv",row.names = FALSE)
